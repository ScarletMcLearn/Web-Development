...
def generate_naved_template(left_link_names, right_link_names, item_number, site_name = "WRITE-SITE-NAME-HERE!"):
              ...
              context = {
                                ...
                                'right_link_index' : ((item_number) - len(left_link_names) - 1),
...
def generate_template_package(left_link_names, right_link_names, site_name= "Ass Fart!"):
    ...
    for item in range(len(combined_list)):
        html = generate_naved_template(left_link_names, right_link_names, item_number= item, site_name= "Ass Fart!")
